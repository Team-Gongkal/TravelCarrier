var weekly = [
  {
    id: 1,
    element: $(".weekly_scroll article"),
    title: "위클리",
    text: `작성하고자하는 위클리에대한 정보가 왼쪽에 기재됩니다.<br>오른쪽 상단의 <em class="hightlight">톱니바퀴 모양 아이콘</em>을 클릭하면 위클리 수정이 가능해요!`,
    positionX: "left",
    x: 37,
    positionY: "top",
    y: 15,
...
$(document).ready(function () {
  ...
  show(weekly,currentIdx);
  prevBtnClick(weekly);
  nextBtnClick(weekly);
});
closeTutorial(weekly);
